...
//        print("the folder of Realm,\(Realm.Configuration.defaultConfiguration.fileURL)");
        ...
        UINavigationBar.appearance().barTintColor = UIColor(red: 0.38, green: 0.21, blue: 0.38, alpha: 1.0);
        UINavigationBar.appearance().barTintColor = UserDefaults.standard.colorForKey(key: "colorTheme") ?? UIColor(red: 0.48, green: 0.26, blue: 0.47, alpha: 1.0);
        return true
    }
